    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("surname", models.CharField(db_comment="Client's surname", max_length=255, verbose_name="Surname")),
                ("name", models.CharField(db_comment="Client's name", max_length=255, verbose_name="Название")),
                (
                    "patronymic",
                    models.CharField(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_id",
                    models.CharField(
                        blank=True, db_comment="Social id", max_length=50, null=True, verbose_name="Telegram id"
                    ),
                ),
                (
                    "username",
                    models.CharField(
                        blank=True, db_comment="Social username", max_length=255, null=True, verbose_name="Username"
                    ),
                ),
                (
                    "client_guid",
